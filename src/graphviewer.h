...
class GraphViewer {
 public:
   ...
   */
  bool setVertexLabel(long long int id, string label);
   ...
   */
  bool setEdgeLabel(long long int id, string label);
  /**
   ...
   */
  bool setEdgeColor(long long int id, string color);
   ...
   */
  bool setVertexColor(long long int id, string color);
   ...
   */
  bool setEdgeThickness(long long int id, int thickness);
   ...
   */
  bool setEdgeWeight(long long int id, int weight);
  /**
   ...
   */
  bool setEdgeFlow(long long int id, int flow);
